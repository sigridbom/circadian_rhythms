...
pacman::p_load(lmerTest, tidyverse, lme4, wesanderson)
```
...
# NB!! 
# rerun for loop in above chunk to make an updated boxplot below 
...
```{r}
plot(modelBFEfreshCirc)
qqnorm(m_temp$coefficients)
plot(m_temp$coefficients)

dataBFE %>% 
  ggplot() + 
  aes(fresh, sinCirc) + geom_smooth(method = "lm")
```
